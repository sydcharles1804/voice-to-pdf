...
_LABEL_HINTS: list[tuple[str, str]] = [
    ...
    ("phone",         "Phone number. The speech-to-text system may transcribe digits as words ('two three seven…') — this is valid input. Accept digit words or numerals and confirm the full number back as digits."),
    ("mobile",        "Mobile number. Accept digits spoken as words or numerals. Confirm the number back in digit form."),
    ("fax",           "Fax number. Accept digits spoken as words or numerals. Confirm the number back in digit form."),
    ...
    ("ssn",           "Social Security Number. Accept digits spoken as words or numerals. Remind the user it is kept secure. Confirm the digits back in XXX-XX-XXXX format."),
